...
namespace Tests\Feature\PetReportSighting;
...
class PetReportSightingTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_store_creates_sighting_for_lost_report(): void
    {
        ...
        $this->assertDatabaseHas('pet_report_sightings', [
            'report_id' => $report->id,
            'user_id' => $sighter->id,
        ]);
    }
    ...
    public function test_store_dispatches_notification_to_report_owner(): void
    {
        ...
        Notification::assertSentTo($owner, PetReportSightingReported::class);
    }
    ...
    public function test_double_submit_returns_existing_sighting(): void
    {
        ...
        $this->assertDatabaseCount('pet_report_sightings', 1);
    }
    ...
    public function test_double_submit_does_not_dispatch_notification(): void
    {
        ...
        Notification::assertSentToTimes($owner, PetReportSightingReported::class, 1);
    ...
    public function test_show_returns_sighting_detail(): void
    {
        ...
        $sighter = User::factory()->create();
        $sighting = PetReportSighting::factory()->create([
            'user_id' => $sighter->id,
            'report_id' => $report->id,
        ]);
